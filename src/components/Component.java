...
public class Component {
    ...
    /**
     * constructor of Component class, sets appropriate values to certain attributes
     * of the class
     */
     ...
     * i.e. adds a pair of direction and component to the HashMap storing connected
     * components of a
     * certain component.
     * 
     * @param c a component to be added.
     * @param d a direction of the component's(this) neighboring cell where the
     *          component (c) is to be added.
     * @return a boolean representing success of the process i.e. true if the
     *         component (c) succfully added,
     *         false if the component (c) failed to be added.
     * @throws PumpConnectablePipeNumberExceedException    when a plumber tried to
     *                                                     connect a component to a
     *                                                     pump
     *                                                     while it is already
     *                                                     connected to maximum
     *                                                     number of connectable
     *                                                     component, e.g. if a pump
     *                                                     is
     *                                                     connectable to 2
     *                                                     components and already is
     *                                                     connected to 2 component,
     *                                                     then a plumber tried to
     *                                                     connect
     *                                                     3rd component, in that
     *                                                     case the exceprion is
     *                                                     thrown.
     * @throws CisternMultipleComponentsConnectedException the way the game is
     *                                                     designed is a spring can
     *                                                     be
     *                                                     connected to at most 1
     *                                                     component, i.e. a pump or
     *                                                     a pipe. the exception is
     *                                                     thrown when a plumber
     *                                                     tried
     *                                                     to connect more that one
     *                                                     components to a Spring.
     * @throws SpringMultipleComponensConnectedException   the way the game is
     *                                                     designed is a cistern can
     *                                                     be
     *                                                     connected to at most 1
     *                                                     component, i.e. a pump or
     *                                                     a pipe. The exception is
     *                                                     thrown when i plumber
     *                                                     tried
     *                                                     to connected more that 1
     *                                                     componetn to a cistern.
     */
    public boolean addConnectedComponent(Component c, Direction d)
            throws PumpConnectablePipeNumberExceedException, CisternMultipleComponentsConnectedException,
        ...
        // first checks connectable pipe number and currently connected pipe
            ...
            if (this.connectedComponents.size() < ((Pump) this).getConnectablePipesNumber()) {
                ...
                throw new PumpConnectablePipeNumberExceedException(
                        "the pump is connected to max number of pipes already.");
            }
        }
        // if the component that is receiving a new component to its neighbouring cell
        // is a cistern
        // prior to add, first checks if it is already connected to a component.
            ...
            if (this.connectedComponents.size() < 1) {
                ...
                throw new CisternMultipleComponentsConnectedException(
                        "the cistern is already connected to a component.");
            }
        }
        // if the component that is receiving a new component to its neighbouring cell
    ...
    /**
     * a method that is used to deconnect a certain component from a component, i.e.
     * to remove a pair of
     * direction and a component (c) from a Hashmap storing pairs of a direction and
     * a component representing
     * connected components of a component.
     * 
     * @param c a component to be removed from the HashMap storing connected
     *          components
     * @return returns true if successfully removed, false is the removing process
     *         failed.
     */
